...
## <a name="news" /> Новости
* (2019-10-22) Выложена [четвертая лекция](lec/lecture04.pdf) и [первое практическое задание](assignments/programming01.ipynb). Дедлайн отправки решений: 12.11.2019 включительно
